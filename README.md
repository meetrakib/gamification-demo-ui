...
Minimal **Next.js** demo for the [gamification-core](https://github.com) API. Use it to list quests, report events, view user progress, and claim rewards — no authentication; you supply a `user_id` in the UI.

Part of the [Gamification & Mini Exchange](https://github.com) ecosystem. The backend lives in **gamification-core** (separate repo).
